namespace SymmetricDS.Admin.Master
{
    ...
    public partial class sym_outgoing_batch
    {
        [Key]
        [Column(Order = 0)]
        ...
        public int total_extract_millis { get; set; }

        public int total_load_millis { get; set; }

        public short? extract_job_flag { get; set; }

        [Column(TypeName = "datetime2")]
        public DateTime? extract_start_time { get; set; }

        [Column(TypeName = "datetime2")]
        public DateTime? transfer_start_time { get; set; }
